# A simple test, will be extended with actual use-cases. 
# From /opensim-core/Bindings/Python/example/build_simple_arm_model.py
...
# Disable visualization, no display available
arm.setUseVisualizer(False) 
...
arm.printToXML(os.path.join(output_dir, "SimpleArm.osim"))
